...
public enum ErrorCode {
    ...
    //sse 에러
    SSE_CONNECTION_ERROR(HttpStatus.INTERNAL_SERVER_ERROR,"SSE 구독 중 연결 실패"),
    SSE_SEND_ERROR(HttpStatus.INTERNAL_SERVER_ERROR,"SSE 전송 중 오류 발생"),
    SSE_NOT_CONNECTED(HttpStatus.BAD_REQUEST, "SSE에 연결되어 있지 않은 상태");
